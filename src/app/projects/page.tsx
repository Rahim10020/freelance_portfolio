...
export default function ProjectsArchive() {
  ...
  const getStatusBadge = (status?: string) => {
    ...
    const statusText =
      t.projects.status[status as keyof typeof t.projects.status];
    const baseClasses =
      "ml-2 inline-flex items-center rounded-full px-3 py-1 text-xs font-medium leading-5";
            ...
            <tbody>
              {projects
                ...
                .map((project, index) => {
                  ...
                  const projectTr =
                    t.projects.list[project.id as keyof typeof t.projects.list];
