            ...
            <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-15 lg:px-24 lg:py-18">
                ...
                <div className="mb-16">
                    ...
                    <div className="flex flex-wrap gap-2 mt-8">
                        {(['all', 'completed', 'in-progress', 'upcoming'] as const).map((filter) => (
                            <button
                                key={filter}
                ...
                <div className="overflow-x-auto">
                    <table className="w-full border-collapse text-left">
                        <thead className="sticky top-0 z-10 transition motion-reduce:transition-none bg-white/50 dark:bg-slate-800/50 shadow-[inset_0_1px_0_0_rgba(148,163,184,0.2)] dark:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:drop-shadow-lg">
                            <tr>
                                <th className="py-4 pr-8 text-sm font-semibold text-slate-900 dark:text-slate-200">{t.projects.tableHeaders.year}</th>
                                <th className="py-4 pr-8 text-sm font-semibold text-slate-900 dark:text-slate-200">{t.projects.tableHeaders.project}</th>
                        ...
                        <tbody>
                            {projects
                                .filter((project) => {
                                    ...
                                    if (activeFilter === 'completed') return !project.status || project.status === 'completed';
                                                ...
                                                <ul className="flex flex-wrap gap-2">
                                                    ...
                                                    {project.technologies.length > 4 && (
                                                        <li className="text-xs text-slate-700">
                                                            +{project.technologies.length - 4} {t.projects.moreTechnologies}
                                                        </li>
                                                    )}
                                                </ul>
                                            </td>
